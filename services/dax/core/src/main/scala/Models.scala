...
final case class UntagResourceResponse(tags: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Tag]] = scala.None)
...
final case class IncreaseReplicationFactorResponse(cluster: scala.Option[org.lyranthe.araethura.dax.models.Cluster] = scala.None)
final case class CreateParameterGroupResponse(parameterGroup: scala.Option[org.lyranthe.araethura.dax.models.ParameterGroup] = scala.None)
case object InvalidVPCNetworkStateFault
case object ClusterQuotaForCustomerExceededFault
final case class SubnetGroup(subnetGroupName: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, vpcId: scala.Option[java.lang.String] = scala.None, subnets: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Subnet]] = scala.None)
...
final case class CreateClusterResponse(cluster: scala.Option[org.lyranthe.araethura.dax.models.Cluster] = scala.None)
...
final case class CreateSubnetGroupResponse(subnetGroup: scala.Option[org.lyranthe.araethura.dax.models.SubnetGroup] = scala.None)
...
final case class DeleteClusterResponse(cluster: scala.Option[org.lyranthe.araethura.dax.models.Cluster] = scala.None)
final case class ListTagsRequest(resourceName: java.lang.String, nextToken: scala.Option[java.lang.String] = scala.None)
final case class DescribeClustersResponse(nextToken: scala.Option[java.lang.String] = scala.None, clusters: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Cluster]] = scala.None)
final case class TagResourceRequest(resourceName: java.lang.String, tags: scala.List[org.lyranthe.araethura.dax.models.Tag])
...
final case class Cluster(nodeIdsToRemove: scala.Option[scala.List[java.lang.String]] = scala.None, securityGroups: scala.Option[scala.List[org.lyranthe.araethura.dax.models.SecurityGroupMembership]] = scala.None, subnetGroup: scala.Option[java.lang.String] = scala.None, status: scala.Option[java.lang.String] = scala.None, iamRoleArn: scala.Option[java.lang.String] = scala.None, nodeType: scala.Option[java.lang.String] = scala.None, clusterName: scala.Option[java.lang.String] = scala.None, preferredMaintenanceWindow: scala.Option[java.lang.String] = scala.None, clusterArn: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, totalNodes: scala.Option[scala.Int] = scala.None, activeNodes: scala.Option[scala.Int] = scala.None, clusterDiscoveryEndpoint: scala.Option[org.lyranthe.araethura.dax.models.Endpoint] = scala.None, notificationConfiguration: scala.Option[org.lyranthe.araethura.dax.models.NotificationConfiguration] = scala.None, parameterGroup: scala.Option[org.lyranthe.araethura.dax.models.ParameterGroupStatus] = scala.None, nodes: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Node]] = scala.None)
case object TagNotFoundFault
final case class TagResourceResponse(tags: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Tag]] = scala.None)
final case class InvalidParameterValueException(message: scala.Option[java.lang.String] = scala.None)
final case class RebootNodeResponse(cluster: scala.Option[org.lyranthe.araethura.dax.models.Cluster] = scala.None)
...
final case class DescribeEventsResponse(nextToken: scala.Option[java.lang.String] = scala.None, events: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Event]] = scala.None)
case object InvalidParameterGroupStateFault
final case class DecreaseReplicationFactorResponse(cluster: scala.Option[org.lyranthe.araethura.dax.models.Cluster] = scala.None)
...
final case class UpdateParameterGroupResponse(parameterGroup: scala.Option[org.lyranthe.araethura.dax.models.ParameterGroup] = scala.None)
final case class DescribeDefaultParametersResponse(nextToken: scala.Option[java.lang.String] = scala.None, parameters: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Parameter]] = scala.None)
final case class ListTagsResponse(tags: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Tag]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class CreateClusterRequest(clusterName: java.lang.String, iamRoleArn: java.lang.String, nodeType: java.lang.String, replicationFactor: scala.Int, notificationTopicArn: scala.Option[java.lang.String] = scala.None, subnetGroupName: scala.Option[java.lang.String] = scala.None, parameterGroupName: scala.Option[java.lang.String] = scala.None, preferredMaintenanceWindow: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, tags: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Tag]] = scala.None, securityGroupIds: scala.Option[scala.List[java.lang.String]] = scala.None, availabilityZones: scala.Option[scala.List[java.lang.String]] = scala.None)
...
final case class DescribeParameterGroupsResponse(nextToken: scala.Option[java.lang.String] = scala.None, parameterGroups: scala.Option[scala.List[org.lyranthe.araethura.dax.models.ParameterGroup]] = scala.None)
...
final case class UpdateClusterResponse(cluster: scala.Option[org.lyranthe.araethura.dax.models.Cluster] = scala.None)
...
final case class DescribeParametersResponse(nextToken: scala.Option[java.lang.String] = scala.None, parameters: scala.Option[scala.List[org.lyranthe.araethura.dax.models.Parameter]] = scala.None)
case object NodeQuotaForClusterExceededFault
case object SubnetGroupNotFoundFault
final case class DescribeSubnetGroupsResponse(nextToken: scala.Option[java.lang.String] = scala.None, subnetGroups: scala.Option[scala.List[org.lyranthe.araethura.dax.models.SubnetGroup]] = scala.None)
...
final case class UpdateSubnetGroupResponse(subnetGroup: scala.Option[org.lyranthe.araethura.dax.models.SubnetGroup] = scala.None)
final case class UpdateParameterGroupRequest(parameterGroupName: java.lang.String, parameterNameValues: scala.List[org.lyranthe.araethura.dax.models.ParameterNameValue])
