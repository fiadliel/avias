package avias.appstream.models
...
final case class Image(name: java.lang.String, platform: scala.Option[java.lang.String] = scala.None, createdTime: scala.Option[java.time.Instant] = scala.None, publicBaseImageReleasedDate: scala.Option[java.time.Instant] = scala.None, arn: scala.Option[java.lang.String] = scala.None, baseImageArn: scala.Option[java.lang.String] = scala.None, displayName: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, state: scala.Option[java.lang.String] = scala.None, applications: scala.Option[scala.List[avias.appstream.models.Application]] = scala.None, visibility: scala.Option[java.lang.String] = scala.None, imageBuilderSupported: scala.Option[scala.Boolean] = scala.None, stateChangeReason: scala.Option[avias.appstream.models.ImageStateChangeReason] = scala.None)
final case class StopFleetRequest(name: java.lang.String)
final case class DescribeImagesResult(images: scala.Option[scala.List[avias.appstream.models.Image]] = scala.None)
final case class UpdateDirectoryConfigResult(directoryConfig: scala.Option[avias.appstream.models.DirectoryConfig] = scala.None)
...
final case class CreateDirectoryConfigRequest(directoryName: java.lang.String, organizationalUnitDistinguishedNames: scala.List[java.lang.String], serviceAccountCredentials: avias.appstream.models.ServiceAccountCredentials)
...
final case class UpdateStackResult(stack: scala.Option[avias.appstream.models.Stack] = scala.None)
...
final case class CreateImageBuilderResult(imageBuilder: scala.Option[avias.appstream.models.ImageBuilder] = scala.None)
...
final case class CreateStackResult(stack: scala.Option[avias.appstream.models.Stack] = scala.None)
...
final case class DeleteImageBuilderResult(imageBuilder: scala.Option[avias.appstream.models.ImageBuilder] = scala.None)
final case class ImageBuilder(name: java.lang.String, stateChangeReason: scala.Option[avias.appstream.models.ImageBuilderStateChangeReason] = scala.None, platform: scala.Option[java.lang.String] = scala.None, createdTime: scala.Option[java.time.Instant] = scala.None, domainJoinInfo: scala.Option[avias.appstream.models.DomainJoinInfo] = scala.None, arn: scala.Option[java.lang.String] = scala.None, imageArn: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, displayName: scala.Option[java.lang.String] = scala.None, instanceType: scala.Option[java.lang.String] = scala.None, imageBuilderErrors: scala.Option[scala.List[avias.appstream.models.ResourceError]] = scala.None, state: scala.Option[java.lang.String] = scala.None, enableDefaultInternetAccess: scala.Option[scala.Boolean] = scala.None, vpcConfig: scala.Option[avias.appstream.models.VpcConfig] = scala.None)
final case class DeleteDirectoryConfigRequest(directoryName: java.lang.String)
final case class CreateImageBuilderRequest(imageName: java.lang.String, instanceType: java.lang.String, name: java.lang.String, displayName: scala.Option[java.lang.String] = scala.None, domainJoinInfo: scala.Option[avias.appstream.models.DomainJoinInfo] = scala.None, enableDefaultInternetAccess: scala.Option[scala.Boolean] = scala.None, vpcConfig: scala.Option[avias.appstream.models.VpcConfig] = scala.None, description: scala.Option[java.lang.String] = scala.None)
final case class UpdateFleetRequest(name: java.lang.String, displayName: scala.Option[java.lang.String] = scala.None, domainJoinInfo: scala.Option[avias.appstream.models.DomainJoinInfo] = scala.None, imageName: scala.Option[java.lang.String] = scala.None, instanceType: scala.Option[java.lang.String] = scala.None, computeCapacity: scala.Option[avias.appstream.models.ComputeCapacity] = scala.None, enableDefaultInternetAccess: scala.Option[scala.Boolean] = scala.None, attributesToDelete: scala.Option[scala.List[java.lang.String]] = scala.None, maxUserDurationInSeconds: scala.Option[scala.Int] = scala.None, disconnectTimeoutInSeconds: scala.Option[scala.Int] = scala.None, deleteVpcConfig: scala.Option[scala.Boolean] = scala.None, vpcConfig: scala.Option[avias.appstream.models.VpcConfig] = scala.None, description: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeSessionsResult(sessions: scala.Option[scala.List[avias.appstream.models.Session]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class CreateStackRequest(name: java.lang.String, description: scala.Option[java.lang.String] = scala.None, displayName: scala.Option[java.lang.String] = scala.None, storageConnectors: scala.Option[scala.List[avias.appstream.models.StorageConnector]] = scala.None)
...
final case class CreateDirectoryConfigResult(directoryConfig: scala.Option[avias.appstream.models.DirectoryConfig] = scala.None)
final case class Fleet(arn: java.lang.String, name: java.lang.String, imageName: java.lang.String, instanceType: java.lang.String, computeCapacityStatus: avias.appstream.models.ComputeCapacityStatus, state: java.lang.String, createdTime: scala.Option[java.time.Instant] = scala.None, fleetErrors: scala.Option[scala.List[avias.appstream.models.FleetError]] = scala.None, domainJoinInfo: scala.Option[avias.appstream.models.DomainJoinInfo] = scala.None, displayName: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, fleetType: scala.Option[java.lang.String] = scala.None, enableDefaultInternetAccess: scala.Option[scala.Boolean] = scala.None, maxUserDurationInSeconds: scala.Option[scala.Int] = scala.None, disconnectTimeoutInSeconds: scala.Option[scala.Int] = scala.None, vpcConfig: scala.Option[avias.appstream.models.VpcConfig] = scala.None)
...
final case class Stack(name: java.lang.String, createdTime: scala.Option[java.time.Instant] = scala.None, storageConnectors: scala.Option[scala.List[avias.appstream.models.StorageConnector]] = scala.None, arn: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, displayName: scala.Option[java.lang.String] = scala.None, stackErrors: scala.Option[scala.List[avias.appstream.models.StackError]] = scala.None)
final case class UpdateDirectoryConfigRequest(directoryName: java.lang.String, organizationalUnitDistinguishedNames: scala.Option[scala.List[java.lang.String]] = scala.None, serviceAccountCredentials: scala.Option[avias.appstream.models.ServiceAccountCredentials] = scala.None)
...
final case class DescribeImageBuildersResult(imageBuilders: scala.Option[scala.List[avias.appstream.models.ImageBuilder]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class StopImageBuilderRequest(name: java.lang.String)
final case class UpdateStackRequest(name: java.lang.String, displayName: scala.Option[java.lang.String] = scala.None, storageConnectors: scala.Option[scala.List[avias.appstream.models.StorageConnector]] = scala.None, deleteStorageConnectors: scala.Option[scala.Boolean] = scala.None, description: scala.Option[java.lang.String] = scala.None)
final case class UpdateFleetResult(fleet: scala.Option[avias.appstream.models.Fleet] = scala.None)
final case class CreateFleetResult(fleet: scala.Option[avias.appstream.models.Fleet] = scala.None)
final case class StopImageBuilderResult(imageBuilder: scala.Option[avias.appstream.models.ImageBuilder] = scala.None)
...
final case class DeleteImageResult(image: scala.Option[avias.appstream.models.Image] = scala.None)
...
final case class CreateFleetRequest(imageName: java.lang.String, instanceType: java.lang.String, computeCapacity: avias.appstream.models.ComputeCapacity, name: java.lang.String, displayName: scala.Option[java.lang.String] = scala.None, domainJoinInfo: scala.Option[avias.appstream.models.DomainJoinInfo] = scala.None, fleetType: scala.Option[java.lang.String] = scala.None, enableDefaultInternetAccess: scala.Option[scala.Boolean] = scala.None, maxUserDurationInSeconds: scala.Option[scala.Int] = scala.None, disconnectTimeoutInSeconds: scala.Option[scala.Int] = scala.None, vpcConfig: scala.Option[avias.appstream.models.VpcConfig] = scala.None, description: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeStacksResult(stacks: scala.Option[scala.List[avias.appstream.models.Stack]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class DescribeFleetsResult(fleets: scala.Option[scala.List[avias.appstream.models.Fleet]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class StartImageBuilderResult(imageBuilder: scala.Option[avias.appstream.models.ImageBuilder] = scala.None)
...
final case class DescribeDirectoryConfigsResult(directoryConfigs: scala.Option[scala.List[avias.appstream.models.DirectoryConfig]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
