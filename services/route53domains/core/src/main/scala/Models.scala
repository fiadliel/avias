...
final case class ViewBillingResponse(nextPageMarker: scala.Option[java.lang.String] = scala.None, billingRecords: scala.Option[scala.List[org.lyranthe.araethura.route53domains.models.BillingRecord]] = scala.None)
...
final case class UpdateDomainNameserversRequest(domainName: java.lang.String, nameservers: scala.List[org.lyranthe.araethura.route53domains.models.Nameserver], fiauthKey: scala.Option[java.lang.String] = scala.None)
...
final case class CheckDomainTransferabilityResponse(transferability: org.lyranthe.araethura.route53domains.models.DomainTransferability)
...
final case class GetDomainSuggestionsResponse(suggestionsList: scala.Option[scala.List[org.lyranthe.araethura.route53domains.models.DomainSuggestion]] = scala.None)
final case class TransferDomainRequest(durationInYears: scala.Int, domainName: java.lang.String, adminContact: org.lyranthe.araethura.route53domains.models.ContactDetail, registrantContact: org.lyranthe.araethura.route53domains.models.ContactDetail, techContact: org.lyranthe.araethura.route53domains.models.ContactDetail, nameservers: scala.Option[scala.List[org.lyranthe.araethura.route53domains.models.Nameserver]] = scala.None, idnLangCode: scala.Option[java.lang.String] = scala.None, authCode: scala.Option[java.lang.String] = scala.None, autoRenew: scala.Option[scala.Boolean] = scala.None, privacyProtectAdminContact: scala.Option[scala.Boolean] = scala.None, privacyProtectRegistrantContact: scala.Option[scala.Boolean] = scala.None, privacyProtectTechContact: scala.Option[scala.Boolean] = scala.None)
...
final case class UpdateDomainContactRequest(domainName: java.lang.String, adminContact: scala.Option[org.lyranthe.araethura.route53domains.models.ContactDetail] = scala.None, registrantContact: scala.Option[org.lyranthe.araethura.route53domains.models.ContactDetail] = scala.None, techContact: scala.Option[org.lyranthe.araethura.route53domains.models.ContactDetail] = scala.None)
final case class EnableDomainTransferLockResponse(operationId: java.lang.String)
final case class UpdateTagsForDomainRequest(domainName: java.lang.String, tagsToUpdate: scala.Option[scala.List[org.lyranthe.araethura.route53domains.models.Tag]] = scala.None)
