...
final case class StartExportTaskRequest(exportDataFormat: scala.Option[scala.List[java.lang.String]] = scala.None, filters: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.ExportFilter]] = scala.None, startTime: scala.Option[java.time.Instant] = scala.None, endTime: scala.Option[java.time.Instant] = scala.None)
...
final case class DeleteTagsRequest(configurationIds: scala.List[java.lang.String], tags: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.Tag]] = scala.None)
...
final case class GetDiscoverySummaryResponse(servers: scala.Option[scala.Long] = scala.None, applications: scala.Option[scala.Long] = scala.None, serversMappedToApplications: scala.Option[scala.Long] = scala.None, serversMappedtoTags: scala.Option[scala.Long] = scala.None, agentSummary: scala.Option[org.lyranthe.araethura.discovery.models.CustomerAgentInfo] = scala.None, connectorSummary: scala.Option[org.lyranthe.araethura.discovery.models.CustomerConnectorInfo] = scala.None)
...
final case class DescribeAgentsResponse(agentsInfo: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.AgentInfo]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class ListConfigurationsRequest(configurationType: java.lang.String, orderBy: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.OrderByElement]] = scala.None, filters: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.Filter]] = scala.None, maxResults: scala.Option[scala.Int] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeTagsRequest(filters: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.TagFilter]] = scala.None, maxResults: scala.Option[scala.Int] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class StartDataCollectionByAgentIdsResponse(agentsConfigurationStatus: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.AgentConfigurationStatus]] = scala.None)
final case class DescribeTagsResponse(tags: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.ConfigurationTag]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class Filter(name: java.lang.String, values: scala.List[java.lang.String], condition: java.lang.String)
final case class ListServerNeighborsResponse(neighbors: scala.List[org.lyranthe.araethura.discovery.models.NeighborConnectionDetail], nextToken: scala.Option[java.lang.String] = scala.None, knownDependencyCount: scala.Option[scala.Long] = scala.None)
final case class DescribeAgentsRequest(agentIds: scala.Option[scala.List[java.lang.String]] = scala.None, filters: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.Filter]] = scala.None, maxResults: scala.Option[scala.Int] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeExportTasksResponse(exportsInfo: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.ExportInfo]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class DescribeExportTasksRequest(exportIds: scala.Option[scala.List[java.lang.String]] = scala.None, filters: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.ExportFilter]] = scala.None, maxResults: scala.Option[scala.Int] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
case object UpdateApplicationResponse
final case class CreateTagsRequest(configurationIds: scala.List[java.lang.String], tags: scala.List[org.lyranthe.araethura.discovery.models.Tag])
...
final case class StopDataCollectionByAgentIdsResponse(agentsConfigurationStatus: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.AgentConfigurationStatus]] = scala.None)
...
final case class AgentInfo(agentId: scala.Option[java.lang.String] = scala.None, hostName: scala.Option[java.lang.String] = scala.None, lastHealthPingTime: scala.Option[java.lang.String] = scala.None, collectionStatus: scala.Option[java.lang.String] = scala.None, version: scala.Option[java.lang.String] = scala.None, registeredTime: scala.Option[java.lang.String] = scala.None, connectorId: scala.Option[java.lang.String] = scala.None, agentType: scala.Option[java.lang.String] = scala.None, agentNetworkInfoList: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.AgentNetworkInfo]] = scala.None, health: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeExportConfigurationsResponse(exportsInfo: scala.Option[scala.List[org.lyranthe.araethura.discovery.models.ExportInfo]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
