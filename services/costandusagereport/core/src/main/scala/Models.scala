...
final case class DescribeReportDefinitionsResponse(reportDefinitions: scala.Option[scala.List[org.lyranthe.araethura.costandusagereport.models.ReportDefinition]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class PutReportDefinitionRequest(reportDefinition: org.lyranthe.araethura.costandusagereport.models.ReportDefinition)
