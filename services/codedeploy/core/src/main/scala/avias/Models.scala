package avias.codedeploy.models
case object InvalidInstanceNameException
final case class DeleteDeploymentGroupOutput(hooksNotCleanedUp: scala.Option[scala.List[avias.codedeploy.models.AutoScalingGroup]] = scala.None)
...
final case class RevisionInfo(revisionLocation: scala.Option[avias.codedeploy.models.RevisionLocation] = scala.None, genericRevisionInfo: scala.Option[avias.codedeploy.models.GenericRevisionInfo] = scala.None)
case object DeploymentDoesNotExistException
final case class ListOnPremisesInstancesInput(registrationStatus: scala.Option[java.lang.String] = scala.None, tagFilters: scala.Option[scala.List[avias.codedeploy.models.TagFilter]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class CreateApplicationInput(applicationName: java.lang.String)
case object InvalidTimeRangeException
final case class InstanceInfo(iamSessionArn: scala.Option[java.lang.String] = scala.None, registerTime: scala.Option[java.time.Instant] = scala.None, deregisterTime: scala.Option[java.time.Instant] = scala.None, instanceArn: scala.Option[java.lang.String] = scala.None, instanceName: scala.Option[java.lang.String] = scala.None, tags: scala.Option[scala.List[avias.codedeploy.models.Tag]] = scala.None, iamUserArn: scala.Option[java.lang.String] = scala.None)
case object InvalidTargetInstancesException
case object BucketNameFilterRequiredException
final case class BatchGetApplicationRevisionsOutput(applicationName: scala.Option[java.lang.String] = scala.None, errorMessage: scala.Option[java.lang.String] = scala.None, revisions: scala.Option[scala.List[avias.codedeploy.models.RevisionInfo]] = scala.None)
final case class CreateDeploymentConfigOutput(deploymentConfigId: scala.Option[java.lang.String] = scala.None)
final case class CreateDeploymentGroupInput(applicationName: java.lang.String, serviceRoleArn: java.lang.String, deploymentGroupName: java.lang.String, triggerConfigurations: scala.Option[scala.List[avias.codedeploy.models.TriggerConfig]] = scala.None, onPremisesTagSet: scala.Option[avias.codedeploy.models.OnPremisesTagSet] = scala.None, blueGreenDeploymentConfiguration: scala.Option[avias.codedeploy.models.BlueGreenDeploymentConfiguration] = scala.None, ec2TagFilters: scala.Option[scala.List[avias.codedeploy.models.EC2TagFilter]] = scala.None, alarmConfiguration: scala.Option[avias.codedeploy.models.AlarmConfiguration] = scala.None, onPremisesInstanceTagFilters: scala.Option[scala.List[avias.codedeploy.models.TagFilter]] = scala.None, ec2TagSet: scala.Option[avias.codedeploy.models.EC2TagSet] = scala.None, autoRollbackConfiguration: scala.Option[avias.codedeploy.models.AutoRollbackConfiguration] = scala.None, deploymentConfigName: scala.Option[java.lang.String] = scala.None, autoScalingGroups: scala.Option[scala.List[java.lang.String]] = scala.None, loadBalancerInfo: scala.Option[avias.codedeploy.models.LoadBalancerInfo] = scala.None, deploymentStyle: scala.Option[avias.codedeploy.models.DeploymentStyle] = scala.None)
...
final case class OnPremisesTagSet(onPremisesTagSetList: scala.Option[scala.List[scala.List[avias.codedeploy.models.TagFilter]]] = scala.None)
...
final case class GetDeploymentInstanceOutput(instanceSummary: scala.Option[avias.codedeploy.models.InstanceSummary] = scala.None)
...
final case class BlueGreenDeploymentConfiguration(terminateBlueInstancesOnDeploymentSuccess: scala.Option[avias.codedeploy.models.BlueInstanceTerminationOption] = scala.None, deploymentReadyOption: scala.Option[avias.codedeploy.models.DeploymentReadyOption] = scala.None, greenFleetProvisioningOption: scala.Option[avias.codedeploy.models.GreenFleetProvisioningOption] = scala.None)
...
final case class BatchGetDeploymentGroupsOutput(deploymentGroupsInfo: scala.Option[scala.List[avias.codedeploy.models.DeploymentGroupInfo]] = scala.None, errorMessage: scala.Option[java.lang.String] = scala.None)
...
final case class AddTagsToOnPremisesInstancesInput(tags: scala.List[avias.codedeploy.models.Tag], instanceNames: scala.List[java.lang.String])
...
final case class TargetInstances(tagFilters: scala.Option[scala.List[avias.codedeploy.models.EC2TagFilter]] = scala.None, autoScalingGroups: scala.Option[scala.List[java.lang.String]] = scala.None, ec2TagSet: scala.Option[avias.codedeploy.models.EC2TagSet] = scala.None)
...
final case class UpdateDeploymentGroupOutput(hooksNotCleanedUp: scala.Option[scala.List[avias.codedeploy.models.AutoScalingGroup]] = scala.None)
case object InvalidDeployedStateFilterException
final case class DeploymentConfigInfo(deploymentConfigId: scala.Option[java.lang.String] = scala.None, deploymentConfigName: scala.Option[java.lang.String] = scala.None, minimumHealthyHosts: scala.Option[avias.codedeploy.models.MinimumHealthyHosts] = scala.None, createTime: scala.Option[java.time.Instant] = scala.None)
...
final case class UpdateDeploymentGroupInput(applicationName: java.lang.String, currentDeploymentGroupName: java.lang.String, triggerConfigurations: scala.Option[scala.List[avias.codedeploy.models.TriggerConfig]] = scala.None, onPremisesTagSet: scala.Option[avias.codedeploy.models.OnPremisesTagSet] = scala.None, blueGreenDeploymentConfiguration: scala.Option[avias.codedeploy.models.BlueGreenDeploymentConfiguration] = scala.None, ec2TagFilters: scala.Option[scala.List[avias.codedeploy.models.EC2TagFilter]] = scala.None, alarmConfiguration: scala.Option[avias.codedeploy.models.AlarmConfiguration] = scala.None, onPremisesInstanceTagFilters: scala.Option[scala.List[avias.codedeploy.models.TagFilter]] = scala.None, serviceRoleArn: scala.Option[java.lang.String] = scala.None, ec2TagSet: scala.Option[avias.codedeploy.models.EC2TagSet] = scala.None, autoRollbackConfiguration: scala.Option[avias.codedeploy.models.AutoRollbackConfiguration] = scala.None, deploymentConfigName: scala.Option[java.lang.String] = scala.None, autoScalingGroups: scala.Option[scala.List[java.lang.String]] = scala.None, newDeploymentGroupName: scala.Option[java.lang.String] = scala.None, loadBalancerInfo: scala.Option[avias.codedeploy.models.LoadBalancerInfo] = scala.None, deploymentStyle: scala.Option[avias.codedeploy.models.DeploymentStyle] = scala.None)
...
final case class GetApplicationOutput(application: scala.Option[avias.codedeploy.models.ApplicationInfo] = scala.None)
...
final case class BatchGetApplicationRevisionsInput(applicationName: java.lang.String, revisions: scala.List[avias.codedeploy.models.RevisionLocation])
...
final case class DeploymentInfo(status: scala.Option[java.lang.String] = scala.None, createTime: scala.Option[java.time.Instant] = scala.None, startTime: scala.Option[java.time.Instant] = scala.None, completeTime: scala.Option[java.time.Instant] = scala.None, deploymentId: scala.Option[java.lang.String] = scala.None, deploymentOverview: scala.Option[avias.codedeploy.models.DeploymentOverview] = scala.None, blueGreenDeploymentConfiguration: scala.Option[avias.codedeploy.models.BlueGreenDeploymentConfiguration] = scala.None, applicationName: scala.Option[java.lang.String] = scala.None, additionalDeploymentStatusInfo: scala.Option[java.lang.String] = scala.None, targetInstances: scala.Option[avias.codedeploy.models.TargetInstances] = scala.None, fileExistsBehavior: scala.Option[java.lang.String] = scala.None, rollbackInfo: scala.Option[avias.codedeploy.models.RollbackInfo] = scala.None, description: scala.Option[java.lang.String] = scala.None, autoRollbackConfiguration: scala.Option[avias.codedeploy.models.AutoRollbackConfiguration] = scala.None, deploymentConfigName: scala.Option[java.lang.String] = scala.None, deploymentGroupName: scala.Option[java.lang.String] = scala.None, loadBalancerInfo: scala.Option[avias.codedeploy.models.LoadBalancerInfo] = scala.None, errorInformation: scala.Option[avias.codedeploy.models.ErrorInformation] = scala.None, ignoreApplicationStopFailures: scala.Option[scala.Boolean] = scala.None, updateOutdatedInstancesOnly: scala.Option[scala.Boolean] = scala.None, instanceTerminationWaitTimeStarted: scala.Option[scala.Boolean] = scala.None, creator: scala.Option[java.lang.String] = scala.None, deploymentStyle: scala.Option[avias.codedeploy.models.DeploymentStyle] = scala.None, previousRevision: scala.Option[avias.codedeploy.models.RevisionLocation] = scala.None, revision: scala.Option[avias.codedeploy.models.RevisionLocation] = scala.None)
final case class GetOnPremisesInstanceOutput(instanceInfo: scala.Option[avias.codedeploy.models.InstanceInfo] = scala.None)
final case class ListApplicationRevisionsOutput(revisions: scala.Option[scala.List[avias.codedeploy.models.RevisionLocation]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class AlarmConfiguration(enabled: scala.Option[scala.Boolean] = scala.None, ignorePollAlarmFailure: scala.Option[scala.Boolean] = scala.None, alarms: scala.Option[scala.List[avias.codedeploy.models.Alarm]] = scala.None)
...
final case class EC2TagSet(ec2TagSetList: scala.Option[scala.List[scala.List[avias.codedeploy.models.EC2TagFilter]]] = scala.None)
...
final case class BatchGetDeploymentsOutput(deploymentsInfo: scala.Option[scala.List[avias.codedeploy.models.DeploymentInfo]] = scala.None)
final case class BatchGetApplicationsOutput(applicationsInfo: scala.Option[scala.List[avias.codedeploy.models.ApplicationInfo]] = scala.None)
case object InvalidRegistrationStatusException
final case class RegisterApplicationRevisionInput(applicationName: java.lang.String, revision: avias.codedeploy.models.RevisionLocation, description: scala.Option[java.lang.String] = scala.None)
...
final case class GetApplicationRevisionOutput(applicationName: scala.Option[java.lang.String] = scala.None, revision: scala.Option[avias.codedeploy.models.RevisionLocation] = scala.None, revisionInfo: scala.Option[avias.codedeploy.models.GenericRevisionInfo] = scala.None)
...
final case class BatchGetDeploymentInstancesOutput(instancesSummary: scala.Option[scala.List[avias.codedeploy.models.InstanceSummary]] = scala.None, errorMessage: scala.Option[java.lang.String] = scala.None)
...
final case class DeploymentGroupInfo(triggerConfigurations: scala.Option[scala.List[avias.codedeploy.models.TriggerConfig]] = scala.None, onPremisesTagSet: scala.Option[avias.codedeploy.models.OnPremisesTagSet] = scala.None, blueGreenDeploymentConfiguration: scala.Option[avias.codedeploy.models.BlueGreenDeploymentConfiguration] = scala.None, applicationName: scala.Option[java.lang.String] = scala.None, ec2TagFilters: scala.Option[scala.List[avias.codedeploy.models.EC2TagFilter]] = scala.None, alarmConfiguration: scala.Option[avias.codedeploy.models.AlarmConfiguration] = scala.None, onPremisesInstanceTagFilters: scala.Option[scala.List[avias.codedeploy.models.TagFilter]] = scala.None, serviceRoleArn: scala.Option[java.lang.String] = scala.None, ec2TagSet: scala.Option[avias.codedeploy.models.EC2TagSet] = scala.None, autoRollbackConfiguration: scala.Option[avias.codedeploy.models.AutoRollbackConfiguration] = scala.None, deploymentConfigName: scala.Option[java.lang.String] = scala.None, deploymentGroupName: scala.Option[java.lang.String] = scala.None, loadBalancerInfo: scala.Option[avias.codedeploy.models.LoadBalancerInfo] = scala.None, deploymentGroupId: scala.Option[java.lang.String] = scala.None, autoScalingGroups: scala.Option[scala.List[avias.codedeploy.models.AutoScalingGroup]] = scala.None, deploymentStyle: scala.Option[avias.codedeploy.models.DeploymentStyle] = scala.None, targetRevision: scala.Option[avias.codedeploy.models.RevisionLocation] = scala.None, lastSuccessfulDeployment: scala.Option[avias.codedeploy.models.LastDeploymentInfo] = scala.None, lastAttemptedDeployment: scala.Option[avias.codedeploy.models.LastDeploymentInfo] = scala.None)
final case class BatchGetDeploymentsInput(deploymentIds: scala.Option[scala.List[java.lang.String]] = scala.None)
final case class LoadBalancerInfo(elbInfoList: scala.Option[scala.List[avias.codedeploy.models.ELBInfo]] = scala.None, targetGroupInfoList: scala.Option[scala.List[avias.codedeploy.models.TargetGroupInfo]] = scala.None)
...
final case class CreateDeploymentInput(applicationName: java.lang.String, targetInstances: scala.Option[avias.codedeploy.models.TargetInstances] = scala.None, fileExistsBehavior: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, autoRollbackConfiguration: scala.Option[avias.codedeploy.models.AutoRollbackConfiguration] = scala.None, deploymentConfigName: scala.Option[java.lang.String] = scala.None, deploymentGroupName: scala.Option[java.lang.String] = scala.None, ignoreApplicationStopFailures: scala.Option[scala.Boolean] = scala.None, updateOutdatedInstancesOnly: scala.Option[scala.Boolean] = scala.None, revision: scala.Option[avias.codedeploy.models.RevisionLocation] = scala.None)
final case class CreateDeploymentConfigInput(deploymentConfigName: java.lang.String, minimumHealthyHosts: avias.codedeploy.models.MinimumHealthyHosts)
...
final case class RevisionLocation(revisionType: scala.Option[java.lang.String] = scala.None, s3Location: scala.Option[avias.codedeploy.models.S3Location] = scala.None, gitHubLocation: scala.Option[avias.codedeploy.models.GitHubLocation] = scala.None)
...
final case class GetApplicationRevisionInput(applicationName: java.lang.String, revision: avias.codedeploy.models.RevisionLocation)
...
final case class GetDeploymentOutput(deploymentInfo: scala.Option[avias.codedeploy.models.DeploymentInfo] = scala.None)
case object InstanceIdRequiredException
final case class RemoveTagsFromOnPremisesInstancesInput(tags: scala.List[avias.codedeploy.models.Tag], instanceNames: scala.List[java.lang.String])
case object InvalidIamSessionArnException
final case class GetDeploymentConfigOutput(deploymentConfigInfo: scala.Option[avias.codedeploy.models.DeploymentConfigInfo] = scala.None)
final case class BatchGetOnPremisesInstancesOutput(instanceInfos: scala.Option[scala.List[avias.codedeploy.models.InstanceInfo]] = scala.None)
case object InvalidDeploymentGroupNameException
final case class LifecycleEvent(lifecycleEventName: scala.Option[java.lang.String] = scala.None, diagnostics: scala.Option[avias.codedeploy.models.Diagnostics] = scala.None, startTime: scala.Option[java.time.Instant] = scala.None, endTime: scala.Option[java.time.Instant] = scala.None, status: scala.Option[java.lang.String] = scala.None)
