package avias.resourcegroupstaggingapi.models
...
final case class GetResourcesOutput(paginationToken: scala.Option[java.lang.String] = scala.None, resourceTagMappingList: scala.Option[scala.List[avias.resourcegroupstaggingapi.models.ResourceTagMapping]] = scala.None)
...
final case class TagResourcesOutput(failedResourcesMap: scala.Option[scala.collection.immutable.Map[java.lang.String, avias.resourcegroupstaggingapi.models.FailureInfo]] = scala.None)
final case class PaginationTokenExpiredException(message: scala.Option[java.lang.String] = scala.None)
final case class UntagResourcesOutput(failedResourcesMap: scala.Option[scala.collection.immutable.Map[java.lang.String, avias.resourcegroupstaggingapi.models.FailureInfo]] = scala.None)
...
final case class ResourceTagMapping(resourceARN: scala.Option[java.lang.String] = scala.None, tags: scala.Option[scala.List[avias.resourcegroupstaggingapi.models.Tag]] = scala.None)
