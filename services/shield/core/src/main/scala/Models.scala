...
final case class ListAttacksResponse(attackSummaries: scala.Option[scala.List[org.lyranthe.araethura.shield.models.AttackSummary]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class ListAttacksRequest(resourceArns: scala.Option[scala.List[java.lang.String]] = scala.None, startTime: scala.Option[org.lyranthe.araethura.shield.models.TimeRange] = scala.None, endTime: scala.Option[org.lyranthe.araethura.shield.models.TimeRange] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
...
final case class DescribeSubscriptionResponse(subscription: scala.Option[org.lyranthe.araethura.shield.models.Subscription] = scala.None)
...
final case class ListProtectionsResponse(protections: scala.Option[scala.List[org.lyranthe.araethura.shield.models.Protection]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class SummarizedAttackVector(vectorType: java.lang.String, vectorCounters: scala.Option[scala.List[org.lyranthe.araethura.shield.models.SummarizedCounter]] = scala.None)
final case class Mitigation(mitigationName: scala.Option[java.lang.String] = scala.None)
final case class SubResourceSummary(`type`: scala.Option[java.lang.String] = scala.None, id: scala.Option[java.lang.String] = scala.None, attackVectors: scala.Option[scala.List[org.lyranthe.araethura.shield.models.SummarizedAttackVector]] = scala.None, counters: scala.Option[scala.List[org.lyranthe.araethura.shield.models.SummarizedCounter]] = scala.None)
...
final case class DescribeProtectionResponse(protection: scala.Option[org.lyranthe.araethura.shield.models.Protection] = scala.None)
...
final case class AttackDetail(attackCounters: scala.Option[scala.List[org.lyranthe.araethura.shield.models.SummarizedCounter]] = scala.None, resourceArn: scala.Option[java.lang.String] = scala.None, attackId: scala.Option[java.lang.String] = scala.None, subResources: scala.Option[scala.List[org.lyranthe.araethura.shield.models.SubResourceSummary]] = scala.None, startTime: scala.Option[java.time.Instant] = scala.None, endTime: scala.Option[java.time.Instant] = scala.None, mitigations: scala.Option[scala.List[org.lyranthe.araethura.shield.models.Mitigation]] = scala.None)
final case class DescribeAttackResponse(attack: scala.Option[org.lyranthe.araethura.shield.models.AttackDetail] = scala.None)
final case class ResourceAlreadyExistsException(message: scala.Option[java.lang.String] = scala.None)
final case class AttackSummary(attackId: scala.Option[java.lang.String] = scala.None, resourceArn: scala.Option[java.lang.String] = scala.None, startTime: scala.Option[java.time.Instant] = scala.None, endTime: scala.Option[java.time.Instant] = scala.None, attackVectors: scala.Option[scala.List[org.lyranthe.araethura.shield.models.AttackVectorDescription]] = scala.None)
