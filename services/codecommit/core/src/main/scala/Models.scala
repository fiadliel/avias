...
final case class GetRepositoryOutput(repositoryMetadata: scala.Option[org.lyranthe.araethura.codecommit.models.RepositoryMetadata] = scala.None)
...
final case class CreateRepositoryOutput(repositoryMetadata: scala.Option[org.lyranthe.araethura.codecommit.models.RepositoryMetadata] = scala.None)
...
final case class CreatePullRequestInput(title: java.lang.String, targets: scala.List[org.lyranthe.araethura.codecommit.models.Target], description: scala.Option[java.lang.String] = scala.None, clientRequestToken: scala.Option[java.lang.String] = scala.None)
...
final case class PostCommentForComparedCommitOutput(beforeBlobId: scala.Option[java.lang.String] = scala.None, afterBlobId: scala.Option[java.lang.String] = scala.None, beforeCommitId: scala.Option[java.lang.String] = scala.None, afterCommitId: scala.Option[java.lang.String] = scala.None, repositoryName: scala.Option[java.lang.String] = scala.None, comment: scala.Option[org.lyranthe.araethura.codecommit.models.Comment] = scala.None, location: scala.Option[org.lyranthe.araethura.codecommit.models.Location] = scala.None)
case object MaximumRepositoryTriggersExceededException
final case class TestRepositoryTriggersOutput(successfulExecutions: scala.Option[scala.List[java.lang.String]] = scala.None, failedExecutions: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.RepositoryTriggerExecutionFailure]] = scala.None)
...
final case class UpdatePullRequestStatusOutput(pullRequest: org.lyranthe.araethura.codecommit.models.PullRequest)
...
final case class PullRequest(pullRequestTargets: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.PullRequestTarget]] = scala.None, authorArn: scala.Option[java.lang.String] = scala.None, pullRequestId: scala.Option[java.lang.String] = scala.None, lastActivityDate: scala.Option[java.time.Instant] = scala.None, clientRequestToken: scala.Option[java.lang.String] = scala.None, title: scala.Option[java.lang.String] = scala.None, pullRequestStatus: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, creationDate: scala.Option[java.time.Instant] = scala.None)
...
final case class PullRequestMergedStateChangedEventMetadata(repositoryName: scala.Option[java.lang.String] = scala.None, destinationReference: scala.Option[java.lang.String] = scala.None, mergeMetadata: scala.Option[org.lyranthe.araethura.codecommit.models.MergeMetadata] = scala.None)
...
final case class PostCommentReplyOutput(comment: scala.Option[org.lyranthe.araethura.codecommit.models.Comment] = scala.None)
case object InvalidMergeOptionException
case object CommitIdDoesNotExistException
final case class GetPullRequestOutput(pullRequest: org.lyranthe.araethura.codecommit.models.PullRequest)
case object InvalidRepositoryTriggerNameException
final case class GetDifferencesOutput(differences: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.Difference]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class GetCommentsForPullRequestOutput(commentsForPullRequestData: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.CommentsForPullRequest]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class CreatePullRequestOutput(pullRequest: org.lyranthe.araethura.codecommit.models.PullRequest)
...
final case class DescribePullRequestEventsOutput(pullRequestEvents: scala.List[org.lyranthe.araethura.codecommit.models.PullRequestEvent], nextToken: scala.Option[java.lang.String] = scala.None)
case object MaximumOpenPullRequestsExceededException
final case class Difference(beforeBlob: scala.Option[org.lyranthe.araethura.codecommit.models.BlobMetadata] = scala.None, afterBlob: scala.Option[org.lyranthe.araethura.codecommit.models.BlobMetadata] = scala.None, changeType: scala.Option[java.lang.String] = scala.None)
final case class GetCommitOutput(commit: org.lyranthe.araethura.codecommit.models.Commit)
...
final case class CommentsForPullRequest(beforeBlobId: scala.Option[java.lang.String] = scala.None, afterBlobId: scala.Option[java.lang.String] = scala.None, pullRequestId: scala.Option[java.lang.String] = scala.None, beforeCommitId: scala.Option[java.lang.String] = scala.None, afterCommitId: scala.Option[java.lang.String] = scala.None, repositoryName: scala.Option[java.lang.String] = scala.None, location: scala.Option[org.lyranthe.araethura.codecommit.models.Location] = scala.None, comments: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.Comment]] = scala.None)
final case class GetRepositoryTriggersOutput(configurationId: scala.Option[java.lang.String] = scala.None, triggers: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.RepositoryTrigger]] = scala.None)
final case class DeleteCommentContentOutput(comment: scala.Option[org.lyranthe.araethura.codecommit.models.Comment] = scala.None)
...
final case class ListRepositoriesOutput(repositories: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.RepositoryNameIdPair]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
case object MultipleRepositoriesInPullRequestException
case object InvalidRepositoryTriggerEventsException
final case class GetCommentOutput(comment: scala.Option[org.lyranthe.araethura.codecommit.models.Comment] = scala.None)
...
final case class BatchGetRepositoriesOutput(repositories: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.RepositoryMetadata]] = scala.None, repositoriesNotFound: scala.Option[scala.List[java.lang.String]] = scala.None)
final case class UpdateCommentOutput(comment: scala.Option[org.lyranthe.araethura.codecommit.models.Comment] = scala.None)
...
final case class UpdatePullRequestTitleOutput(pullRequest: org.lyranthe.araethura.codecommit.models.PullRequest)
case object BlobIdDoesNotExistException
case object TargetsRequiredException
final case class DeleteBranchOutput(deletedBranch: scala.Option[org.lyranthe.araethura.codecommit.models.BranchInfo] = scala.None)
...
final case class GetBranchOutput(branch: scala.Option[org.lyranthe.araethura.codecommit.models.BranchInfo] = scala.None)
...
final case class Commit(author: scala.Option[org.lyranthe.araethura.codecommit.models.UserInfo] = scala.None, committer: scala.Option[org.lyranthe.araethura.codecommit.models.UserInfo] = scala.None, commitId: scala.Option[java.lang.String] = scala.None, treeId: scala.Option[java.lang.String] = scala.None, additionalData: scala.Option[java.lang.String] = scala.None, parents: scala.Option[scala.List[java.lang.String]] = scala.None, message: scala.Option[java.lang.String] = scala.None)
...
final case class MergePullRequestByFastForwardOutput(pullRequest: scala.Option[org.lyranthe.araethura.codecommit.models.PullRequest] = scala.None)
...
final case class PutRepositoryTriggersInput(repositoryName: java.lang.String, triggers: scala.List[org.lyranthe.araethura.codecommit.models.RepositoryTrigger])
...
final case class PullRequestEvent(eventDate: scala.Option[java.time.Instant] = scala.None, pullRequestStatusChangedEventMetadata: scala.Option[org.lyranthe.araethura.codecommit.models.PullRequestStatusChangedEventMetadata] = scala.None, actorArn: scala.Option[java.lang.String] = scala.None, pullRequestId: scala.Option[java.lang.String] = scala.None, pullRequestSourceReferenceUpdatedEventMetadata: scala.Option[org.lyranthe.araethura.codecommit.models.PullRequestSourceReferenceUpdatedEventMetadata] = scala.None, pullRequestMergedStateChangedEventMetadata: scala.Option[org.lyranthe.araethura.codecommit.models.PullRequestMergedStateChangedEventMetadata] = scala.None, pullRequestEventType: scala.Option[java.lang.String] = scala.None)
...
final case class GetCommentsForComparedCommitOutput(commentsForComparedCommitData: scala.Option[scala.List[org.lyranthe.araethura.codecommit.models.CommentsForComparedCommit]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)