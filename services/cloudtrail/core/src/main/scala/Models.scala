package avias.cloudtrail.models
...
final case class DescribeTrailsResponse(trailList: scala.Option[scala.List[avias.cloudtrail.models.Trail]] = scala.None)
...
final case class PutEventSelectorsResponse(trailARN: scala.Option[java.lang.String] = scala.None, eventSelectors: scala.Option[scala.List[avias.cloudtrail.models.EventSelector]] = scala.None)
...
final case class PutEventSelectorsRequest(trailName: java.lang.String, eventSelectors: scala.List[avias.cloudtrail.models.EventSelector])
...
final case class AddTagsRequest(resourceId: java.lang.String, tagsList: scala.Option[scala.List[avias.cloudtrail.models.Tag]] = scala.None)
...
final case class ResourceTag(resourceId: scala.Option[java.lang.String] = scala.None, tagsList: scala.Option[scala.List[avias.cloudtrail.models.Tag]] = scala.None)
...
final case class LookupEventsRequest(lookupAttributes: scala.Option[scala.List[avias.cloudtrail.models.LookupAttribute]] = scala.None, startTime: scala.Option[java.time.Instant] = scala.None, endTime: scala.Option[java.time.Instant] = scala.None, maxResults: scala.Option[scala.Int] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
case object InvalidLookupAttributesException
final case class RemoveTagsRequest(resourceId: java.lang.String, tagsList: scala.Option[scala.List[avias.cloudtrail.models.Tag]] = scala.None)
case object InvalidMaxResultsException
case object InvalidTokenException
final case class ListTagsResponse(resourceTagList: scala.Option[scala.List[avias.cloudtrail.models.ResourceTag]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class Event(cloudTrailEvent: scala.Option[java.lang.String] = scala.None, username: scala.Option[java.lang.String] = scala.None, eventSource: scala.Option[java.lang.String] = scala.None, eventName: scala.Option[java.lang.String] = scala.None, eventId: scala.Option[java.lang.String] = scala.None, eventTime: scala.Option[java.time.Instant] = scala.None, resources: scala.Option[scala.List[avias.cloudtrail.models.Resource]] = scala.None)
...
final case class LookupEventsResponse(events: scala.Option[scala.List[avias.cloudtrail.models.Event]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListPublicKeysResponse(publicKeyList: scala.Option[scala.List[avias.cloudtrail.models.PublicKey]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class EventSelector(readWriteType: scala.Option[java.lang.String] = scala.None, includeManagementEvents: scala.Option[scala.Boolean] = scala.None, dataResources: scala.Option[scala.List[avias.cloudtrail.models.DataResource]] = scala.None)
final case class GetEventSelectorsResponse(trailARN: scala.Option[java.lang.String] = scala.None, eventSelectors: scala.Option[scala.List[avias.cloudtrail.models.EventSelector]] = scala.None)
