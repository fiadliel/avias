package avias.servermigration.models
...
final case class Server(replicationJobTerminated: scala.Option[scala.Boolean] = scala.None, serverType: scala.Option[java.lang.String] = scala.None, replicationJobId: scala.Option[java.lang.String] = scala.None, serverId: scala.Option[java.lang.String] = scala.None, vmServer: scala.Option[avias.servermigration.models.VmServer] = scala.None)
final case class GetServersResponse(lastModifiedOn: scala.Option[java.time.Instant] = scala.None, serverCatalogStatus: scala.Option[java.lang.String] = scala.None, serverList: scala.Option[scala.List[avias.servermigration.models.Server]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class GetReplicationRunsResponse(replicationJob: scala.Option[avias.servermigration.models.ReplicationJob] = scala.None, replicationRunList: scala.Option[scala.List[avias.servermigration.models.ReplicationRun]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class GetConnectorsResponse(connectorList: scala.Option[scala.List[avias.servermigration.models.Connector]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ReplicationJob(roleName: scala.Option[java.lang.String] = scala.None, seedReplicationTime: scala.Option[java.time.Instant] = scala.None, nextReplicationRunStartTime: scala.Option[java.time.Instant] = scala.None, state: scala.Option[java.lang.String] = scala.None, serverType: scala.Option[java.lang.String] = scala.None, statusMessage: scala.Option[java.lang.String] = scala.None, latestAmiId: scala.Option[java.lang.String] = scala.None, replicationJobId: scala.Option[java.lang.String] = scala.None, replicationRunList: scala.Option[scala.List[avias.servermigration.models.ReplicationRun]] = scala.None, serverId: scala.Option[java.lang.String] = scala.None, licenseType: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, vmServer: scala.Option[avias.servermigration.models.VmServer] = scala.None, frequency: scala.Option[scala.Int] = scala.None)
...
final case class GetReplicationJobsResponse(replicationJobList: scala.Option[scala.List[avias.servermigration.models.ReplicationJob]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class VmServer(vmManagerType: scala.Option[java.lang.String] = scala.None, vmManagerName: scala.Option[java.lang.String] = scala.None, vmServerAddress: scala.Option[avias.servermigration.models.VmServerAddress] = scala.None, vmName: scala.Option[java.lang.String] = scala.None, vmPath: scala.Option[java.lang.String] = scala.None)
