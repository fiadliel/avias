...
final case class ListGrantsResponse(grants: scala.Option[scala.List[org.lyranthe.araethura.kms.models.GrantListEntry]] = scala.None, nextMarker: scala.Option[java.lang.String] = scala.None, truncated: scala.Option[scala.Boolean] = scala.None)
...
final case class DescribeKeyResponse(keyMetadata: scala.Option[org.lyranthe.araethura.kms.models.KeyMetadata] = scala.None)
...
final case class ListAliasesResponse(aliases: scala.Option[scala.List[org.lyranthe.araethura.kms.models.AliasListEntry]] = scala.None, nextMarker: scala.Option[java.lang.String] = scala.None, truncated: scala.Option[scala.Boolean] = scala.None)
...
final case class ListResourceTagsResponse(tags: scala.Option[scala.List[org.lyranthe.araethura.kms.models.Tag]] = scala.None, nextMarker: scala.Option[java.lang.String] = scala.None, truncated: scala.Option[scala.Boolean] = scala.None)
final case class DeleteAliasRequest(aliasName: java.lang.String)
final case class TagResourceRequest(keyId: java.lang.String, tags: scala.List[org.lyranthe.araethura.kms.models.Tag])
...
final case class ListKeysResponse(keys: scala.Option[scala.List[org.lyranthe.araethura.kms.models.KeyListEntry]] = scala.None, nextMarker: scala.Option[java.lang.String] = scala.None, truncated: scala.Option[scala.Boolean] = scala.None)
...
final case class GrantListEntry(grantId: scala.Option[java.lang.String] = scala.None, creationDate: scala.Option[java.time.Instant] = scala.None, granteePrincipal: scala.Option[java.lang.String] = scala.None, retiringPrincipal: scala.Option[java.lang.String] = scala.None, issuingAccount: scala.Option[java.lang.String] = scala.None, constraints: scala.Option[org.lyranthe.araethura.kms.models.GrantConstraints] = scala.None, keyId: scala.Option[java.lang.String] = scala.None, operations: scala.Option[scala.List[java.lang.String]] = scala.None, name: scala.Option[java.lang.String] = scala.None)
...
final case class CreateKeyRequest(origin: scala.Option[java.lang.String] = scala.None, tags: scala.Option[scala.List[org.lyranthe.araethura.kms.models.Tag]] = scala.None, policy: scala.Option[java.lang.String] = scala.None, bypassPolicyLockoutSafetyCheck: scala.Option[scala.Boolean] = scala.None, description: scala.Option[java.lang.String] = scala.None, keyUsage: scala.Option[java.lang.String] = scala.None)
case object ImportKeyMaterialResponse
final case class CreateGrantRequest(granteePrincipal: java.lang.String, keyId: java.lang.String, operations: scala.List[java.lang.String], retiringPrincipal: scala.Option[java.lang.String] = scala.None, constraints: scala.Option[org.lyranthe.araethura.kms.models.GrantConstraints] = scala.None, grantTokens: scala.Option[scala.List[java.lang.String]] = scala.None, name: scala.Option[java.lang.String] = scala.None)
...
final case class CreateKeyResponse(keyMetadata: scala.Option[org.lyranthe.araethura.kms.models.KeyMetadata] = scala.None)
