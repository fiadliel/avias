...
final case class PutEventsResponse(failedEntryCount: scala.Option[scala.Int] = scala.None, entries: scala.Option[scala.List[avias.events.models.PutEventsResultEntry]] = scala.None)
...
final case class RunCommandParameters(runCommandTargets: scala.List[avias.events.models.RunCommandTarget])
...
final case class ListRulesResponse(rules: scala.Option[scala.List[avias.events.models.Rule]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
case object InvalidEventPatternException
final case class PutEventsRequest(entries: scala.List[avias.events.models.PutEventsRequestEntry])
...
final case class Target(arn: java.lang.String, id: java.lang.String, runCommandParameters: scala.Option[avias.events.models.RunCommandParameters] = scala.None, input: scala.Option[java.lang.String] = scala.None, roleArn: scala.Option[java.lang.String] = scala.None, inputPath: scala.Option[java.lang.String] = scala.None, ecsParameters: scala.Option[avias.events.models.EcsParameters] = scala.None, inputTransformer: scala.Option[avias.events.models.InputTransformer] = scala.None, kinesisParameters: scala.Option[avias.events.models.KinesisParameters] = scala.None)
...
final case class ListTargetsByRuleResponse(targets: scala.Option[scala.List[avias.events.models.Target]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class PutTargetsRequest(rule: java.lang.String, targets: scala.List[avias.events.models.Target])
...
final case class RemoveTargetsResponse(failedEntryCount: scala.Option[scala.Int] = scala.None, failedEntries: scala.Option[scala.List[avias.events.models.RemoveTargetsResultEntry]] = scala.None)
...
final case class PutTargetsResponse(failedEntryCount: scala.Option[scala.Int] = scala.None, failedEntries: scala.Option[scala.List[avias.events.models.PutTargetsResultEntry]] = scala.None)
