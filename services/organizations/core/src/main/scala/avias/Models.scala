package avias.organizations.models
...
final case class DescribeCreateAccountStatusResponse(createAccountStatus: scala.Option[avias.organizations.models.CreateAccountStatus] = scala.None)
...
final case class ListTargetsForPolicyResponse(targets: scala.Option[scala.List[avias.organizations.models.PolicyTargetSummary]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class InviteAccountToOrganizationRequest(target: avias.organizations.models.HandshakeParty, notes: scala.Option[java.lang.String] = scala.None)
...
final case class ListParentsResponse(parents: scala.Option[scala.List[avias.organizations.models.Parent]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class DescribePolicyResponse(policy: scala.Option[avias.organizations.models.Policy] = scala.None)
...
final case class DeclineHandshakeResponse(handshake: scala.Option[avias.organizations.models.Handshake] = scala.None)
...
final case class ListPoliciesResponse(policies: scala.Option[scala.List[avias.organizations.models.PolicySummary]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class Root(id: scala.Option[java.lang.String] = scala.None, arn: scala.Option[java.lang.String] = scala.None, name: scala.Option[java.lang.String] = scala.None, policyTypes: scala.Option[scala.List[avias.organizations.models.PolicyTypeSummary]] = scala.None)
...
final case class CancelHandshakeResponse(handshake: scala.Option[avias.organizations.models.Handshake] = scala.None)
...
final case class DisablePolicyTypeResponse(root: scala.Option[avias.organizations.models.Root] = scala.None)
...
final case class ListAccountsResponse(accounts: scala.Option[scala.List[avias.organizations.models.Account]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListHandshakesForOrganizationResponse(handshakes: scala.Option[scala.List[avias.organizations.models.Handshake]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class Handshake(requestedTimestamp: scala.Option[java.time.Instant] = scala.None, expirationTimestamp: scala.Option[java.time.Instant] = scala.None, resources: scala.Option[scala.List[avias.organizations.models.HandshakeResource]] = scala.None, id: scala.Option[java.lang.String] = scala.None, arn: scala.Option[java.lang.String] = scala.None, parties: scala.Option[scala.List[avias.organizations.models.HandshakeParty]] = scala.None, state: scala.Option[java.lang.String] = scala.None, action: scala.Option[java.lang.String] = scala.None)
...
final case class ListAccountsForParentResponse(accounts: scala.Option[scala.List[avias.organizations.models.Account]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class Policy(policySummary: scala.Option[avias.organizations.models.PolicySummary] = scala.None, content: scala.Option[java.lang.String] = scala.None)
...
final case class UpdatePolicyResponse(policy: scala.Option[avias.organizations.models.Policy] = scala.None)
...
final case class DescribeOrganizationResponse(organization: scala.Option[avias.organizations.models.Organization] = scala.None)
final case class DescribeHandshakeResponse(handshake: scala.Option[avias.organizations.models.Handshake] = scala.None)
final case class DescribeAccountResponse(account: scala.Option[avias.organizations.models.Account] = scala.None)
final case class DisablePolicyTypeRequest(rootId: java.lang.String, policyType: java.lang.String)
final case class CreateOrganizationalUnitResponse(organizationalUnit: scala.Option[avias.organizations.models.OrganizationalUnit] = scala.None)
...
final case class ListAWSServiceAccessForOrganizationResponse(enabledServicePrincipals: scala.Option[scala.List[avias.organizations.models.EnabledServicePrincipal]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class AcceptHandshakeResponse(handshake: scala.Option[avias.organizations.models.Handshake] = scala.None)
final case class AlreadyInOrganizationException(message: scala.Option[java.lang.String] = scala.None)
final case class ListHandshakesForAccountResponse(handshakes: scala.Option[scala.List[avias.organizations.models.Handshake]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class DetachPolicyRequest(policyId: java.lang.String, targetId: java.lang.String)
final case class ListOrganizationalUnitsForParentResponse(organizationalUnits: scala.Option[scala.List[avias.organizations.models.OrganizationalUnit]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class InviteAccountToOrganizationResponse(handshake: scala.Option[avias.organizations.models.Handshake] = scala.None)
final case class AcceptHandshakeRequest(handshakeId: java.lang.String)
final case class CreatePolicyResponse(policy: scala.Option[avias.organizations.models.Policy] = scala.None)
...
final case class ListPoliciesForTargetResponse(policies: scala.Option[scala.List[avias.organizations.models.PolicySummary]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListCreateAccountStatusResponse(createAccountStatuses: scala.Option[scala.List[avias.organizations.models.CreateAccountStatus]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListHandshakesForAccountRequest(filter: scala.Option[avias.organizations.models.HandshakeFilter] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
final case class DestinationParentNotFoundException(message: scala.Option[java.lang.String] = scala.None)
final case class EnableAllFeaturesResponse(handshake: scala.Option[avias.organizations.models.Handshake] = scala.None)
final case class ListRootsResponse(roots: scala.Option[scala.List[avias.organizations.models.Root]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class CreateOrganizationResponse(organization: scala.Option[avias.organizations.models.Organization] = scala.None)
...
final case class HandshakeResource(value: scala.Option[java.lang.String] = scala.None, `type`: scala.Option[java.lang.String] = scala.None, resources: scala.Option[scala.List[avias.organizations.models.HandshakeResource]] = scala.None)
...
final case class UpdateOrganizationalUnitResponse(organizationalUnit: scala.Option[avias.organizations.models.OrganizationalUnit] = scala.None)
...
final case class DescribeOrganizationalUnitResponse(organizationalUnit: scala.Option[avias.organizations.models.OrganizationalUnit] = scala.None)
...
final case class Organization(arn: scala.Option[java.lang.String] = scala.None, masterAccountArn: scala.Option[java.lang.String] = scala.None, featureSet: scala.Option[java.lang.String] = scala.None, masterAccountEmail: scala.Option[java.lang.String] = scala.None, availablePolicyTypes: scala.Option[scala.List[avias.organizations.models.PolicyTypeSummary]] = scala.None, masterAccountId: scala.Option[java.lang.String] = scala.None, id: scala.Option[java.lang.String] = scala.None)
...
final case class EnablePolicyTypeResponse(root: scala.Option[avias.organizations.models.Root] = scala.None)
final case class ListChildrenResponse(children: scala.Option[scala.List[avias.organizations.models.Child]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListHandshakesForOrganizationRequest(filter: scala.Option[avias.organizations.models.HandshakeFilter] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
final case class ConcurrentModificationException(message: scala.Option[java.lang.String] = scala.None)
final case class CreateAccountResponse(createAccountStatus: scala.Option[avias.organizations.models.CreateAccountStatus] = scala.None)
