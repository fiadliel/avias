...
final case class DescribeStreamSummaryOutput(streamDescriptionSummary: org.lyranthe.araethura.kinesis.models.StreamDescriptionSummary)
...
final case class DescribeStreamOutput(streamDescription: org.lyranthe.araethura.kinesis.models.StreamDescription)
...
final case class PutRecordsInput(records: scala.List[org.lyranthe.araethura.kinesis.models.PutRecordsRequestEntry], streamName: java.lang.String)
final case class ListTagsForStreamOutput(tags: scala.List[org.lyranthe.araethura.kinesis.models.Tag], hasMoreTags: scala.Boolean)
...
final case class StreamDescription(streamCreationTimestamp: java.time.Instant, streamStatus: java.lang.String, hasMoreShards: scala.Boolean, retentionPeriodHours: scala.Int, streamARN: java.lang.String, shards: scala.List[org.lyranthe.araethura.kinesis.models.Shard], streamName: java.lang.String, enhancedMonitoring: scala.List[org.lyranthe.araethura.kinesis.models.EnhancedMetrics], encryptionType: scala.Option[java.lang.String] = scala.None, keyId: scala.Option[java.lang.String] = scala.None)
...
final case class GetRecordsOutput(records: scala.List[org.lyranthe.araethura.kinesis.models.Record], nextShardIterator: scala.Option[java.lang.String] = scala.None, millisBehindLatest: scala.Option[scala.Long] = scala.None)
...
final case class Shard(shardId: java.lang.String, hashKeyRange: org.lyranthe.araethura.kinesis.models.HashKeyRange, sequenceNumberRange: org.lyranthe.araethura.kinesis.models.SequenceNumberRange, parentShardId: scala.Option[java.lang.String] = scala.None, adjacentParentShardId: scala.Option[java.lang.String] = scala.None)
...
final case class PutRecordsOutput(records: scala.List[org.lyranthe.araethura.kinesis.models.PutRecordsResultEntry], failedRecordCount: scala.Option[scala.Int] = scala.None, encryptionType: scala.Option[java.lang.String] = scala.None)
