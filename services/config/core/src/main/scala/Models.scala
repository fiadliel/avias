...
final case class ComplianceByResource(resourceType: scala.Option[java.lang.String] = scala.None, resourceId: scala.Option[java.lang.String] = scala.None, compliance: scala.Option[org.lyranthe.araethura.config.models.Compliance] = scala.None)
...
final case class GetResourceConfigHistoryResponse(configurationItems: scala.Option[scala.List[org.lyranthe.araethura.config.models.ConfigurationItem]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeConfigRuleEvaluationStatusResponse(configRulesEvaluationStatus: scala.Option[scala.List[org.lyranthe.araethura.config.models.ConfigRuleEvaluationStatus]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class Source(owner: java.lang.String, sourceIdentifier: java.lang.String, sourceDetails: scala.Option[scala.List[org.lyranthe.araethura.config.models.SourceDetail]] = scala.None)
...
final case class PutConfigRuleRequest(configRule: org.lyranthe.araethura.config.models.ConfigRule)
...
final case class EvaluationResultIdentifier(evaluationResultQualifier: scala.Option[org.lyranthe.araethura.config.models.EvaluationResultQualifier] = scala.None, orderingTimestamp: scala.Option[java.time.Instant] = scala.None)
final case class PutEvaluationsRequest(resultToken: java.lang.String, evaluations: scala.Option[scala.List[org.lyranthe.araethura.config.models.Evaluation]] = scala.None, testMode: scala.Option[scala.Boolean] = scala.None)
...
final case class DescribeConfigurationRecordersResponse(configurationRecorders: scala.Option[scala.List[org.lyranthe.araethura.config.models.ConfigurationRecorder]] = scala.None)
...
final case class GetComplianceDetailsByResourceResponse(evaluationResults: scala.Option[scala.List[org.lyranthe.araethura.config.models.EvaluationResult]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ConfigurationRecorder(name: scala.Option[java.lang.String] = scala.None, roleARN: scala.Option[java.lang.String] = scala.None, recordingGroup: scala.Option[org.lyranthe.araethura.config.models.RecordingGroup] = scala.None)
...
final case class GetComplianceDetailsByConfigRuleResponse(evaluationResults: scala.Option[scala.List[org.lyranthe.araethura.config.models.EvaluationResult]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class PutEvaluationsResponse(failedEvaluations: scala.Option[scala.List[org.lyranthe.araethura.config.models.Evaluation]] = scala.None)
final case class DescribeDeliveryChannelsResponse(deliveryChannels: scala.Option[scala.List[org.lyranthe.araethura.config.models.DeliveryChannel]] = scala.None)
final case class ComplianceSummary(compliantResourceCount: scala.Option[org.lyranthe.araethura.config.models.ComplianceContributorCount] = scala.None, nonCompliantResourceCount: scala.Option[org.lyranthe.araethura.config.models.ComplianceContributorCount] = scala.None, complianceSummaryTimestamp: scala.Option[java.time.Instant] = scala.None)
final case class PutDeliveryChannelRequest(deliveryChannel: org.lyranthe.araethura.config.models.DeliveryChannel)
case object NoSuchBucketException
final case class EvaluationResult(resultToken: scala.Option[java.lang.String] = scala.None, evaluationResultIdentifier: scala.Option[org.lyranthe.araethura.config.models.EvaluationResultIdentifier] = scala.None, complianceType: scala.Option[java.lang.String] = scala.None, annotation: scala.Option[java.lang.String] = scala.None, resultRecordedTime: scala.Option[java.time.Instant] = scala.None, configRuleInvokedTime: scala.Option[java.time.Instant] = scala.None)
...
final case class ConfigRule(source: org.lyranthe.araethura.config.models.Source, maximumExecutionFrequency: scala.Option[java.lang.String] = scala.None, inputParameters: scala.Option[java.lang.String] = scala.None, configRuleArn: scala.Option[java.lang.String] = scala.None, configRuleId: scala.Option[java.lang.String] = scala.None, configRuleState: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, configRuleName: scala.Option[java.lang.String] = scala.None, scope: scala.Option[org.lyranthe.araethura.config.models.Scope] = scala.None)
final case class DescribeDeliveryChannelStatusResponse(deliveryChannelsStatus: scala.Option[scala.List[org.lyranthe.araethura.config.models.DeliveryChannelStatus]] = scala.None)
case object ResourceInUseException
case object InsufficientPermissionsException
final case class ComplianceByConfigRule(configRuleName: scala.Option[java.lang.String] = scala.None, compliance: scala.Option[org.lyranthe.araethura.config.models.Compliance] = scala.None)
...
final case class DescribeConfigurationRecorderStatusResponse(configurationRecordersStatus: scala.Option[scala.List[org.lyranthe.araethura.config.models.ConfigurationRecorderStatus]] = scala.None)
...
final case class DeliveryChannelStatus(name: scala.Option[java.lang.String] = scala.None, configSnapshotDeliveryInfo: scala.Option[org.lyranthe.araethura.config.models.ConfigExportDeliveryInfo] = scala.None, configHistoryDeliveryInfo: scala.Option[org.lyranthe.araethura.config.models.ConfigExportDeliveryInfo] = scala.None, configStreamDeliveryInfo: scala.Option[org.lyranthe.araethura.config.models.ConfigStreamDeliveryInfo] = scala.None)
...
final case class ListDiscoveredResourcesResponse(resourceIdentifiers: scala.Option[scala.List[org.lyranthe.araethura.config.models.ResourceIdentifier]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
case object InvalidResultTokenException
final case class DescribeComplianceByResourceResponse(complianceByResources: scala.Option[scala.List[org.lyranthe.araethura.config.models.ComplianceByResource]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class Compliance(complianceType: scala.Option[java.lang.String] = scala.None, complianceContributorCount: scala.Option[org.lyranthe.araethura.config.models.ComplianceContributorCount] = scala.None)
...
final case class DescribeComplianceByConfigRuleResponse(complianceByConfigRules: scala.Option[scala.List[org.lyranthe.araethura.config.models.ComplianceByConfigRule]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class StartConfigRulesEvaluationRequest(configRuleNames: scala.Option[scala.List[java.lang.String]] = scala.None)
final case class GetComplianceSummaryByResourceTypeResponse(complianceSummariesByResourceType: scala.Option[scala.List[org.lyranthe.araethura.config.models.ComplianceSummaryByResourceType]] = scala.None)
...
final case class GetDiscoveredResourceCountsResponse(totalDiscoveredResources: scala.Option[scala.Long] = scala.None, resourceCounts: scala.Option[scala.List[org.lyranthe.araethura.config.models.ResourceCount]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class DescribeConfigRulesResponse(configRules: scala.Option[scala.List[org.lyranthe.araethura.config.models.ConfigRule]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
case object InvalidLimitException
case object InvalidS3KeyPrefixException
final case class ComplianceSummaryByResourceType(resourceType: scala.Option[java.lang.String] = scala.None, complianceSummary: scala.Option[org.lyranthe.araethura.config.models.ComplianceSummary] = scala.None)