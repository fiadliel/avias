...
final case class DescribeMetricFiltersResponse(metricFilters: scala.Option[scala.List[org.lyranthe.araethura.logs.models.MetricFilter]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class TestMetricFilterResponse(matches: scala.Option[scala.List[org.lyranthe.araethura.logs.models.MetricFilterMatchRecord]] = scala.None)
final case class DataAlreadyAcceptedException(expectedSequenceToken: scala.Option[java.lang.String] = scala.None)
final case class PutLogEventsResponse(nextSequenceToken: scala.Option[java.lang.String] = scala.None, rejectedLogEventsInfo: scala.Option[org.lyranthe.araethura.logs.models.RejectedLogEventsInfo] = scala.None)
...
final case class DescribeDestinationsResponse(destinations: scala.Option[scala.List[org.lyranthe.araethura.logs.models.Destination]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class PutDestinationResponse(destination: scala.Option[org.lyranthe.araethura.logs.models.Destination] = scala.None)
case object InvalidOperationException
final case class GetLogEventsResponse(events: scala.Option[scala.List[org.lyranthe.araethura.logs.models.OutputLogEvent]] = scala.None, nextForwardToken: scala.Option[java.lang.String] = scala.None, nextBackwardToken: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeLogGroupsResponse(logGroups: scala.Option[scala.List[org.lyranthe.araethura.logs.models.LogGroup]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
final case class DescribeLogStreamsResponse(logStreams: scala.Option[scala.List[org.lyranthe.araethura.logs.models.LogStream]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeSubscriptionFiltersResponse(subscriptionFilters: scala.Option[scala.List[org.lyranthe.araethura.logs.models.SubscriptionFilter]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class PutResourcePolicyResponse(resourcePolicy: scala.Option[org.lyranthe.araethura.logs.models.ResourcePolicy] = scala.None)
...
final case class FilterLogEventsResponse(events: scala.Option[scala.List[org.lyranthe.araethura.logs.models.FilteredLogEvent]] = scala.None, searchedLogStreams: scala.Option[scala.List[org.lyranthe.araethura.logs.models.SearchedLogStream]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class MetricFilter(filterPattern: scala.Option[java.lang.String] = scala.None, metricTransformations: scala.Option[scala.List[org.lyranthe.araethura.logs.models.MetricTransformation]] = scala.None, creationTime: scala.Option[scala.Long] = scala.None, filterName: scala.Option[java.lang.String] = scala.None, logGroupName: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeResourcePoliciesResponse(resourcePolicies: scala.Option[scala.List[org.lyranthe.araethura.logs.models.ResourcePolicy]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class DescribeExportTasksResponse(exportTasks: scala.Option[scala.List[org.lyranthe.araethura.logs.models.ExportTask]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class PutMetricFilterRequest(logGroupName: java.lang.String, filterName: java.lang.String, filterPattern: java.lang.String, metricTransformations: scala.List[org.lyranthe.araethura.logs.models.MetricTransformation])
...
final case class PutLogEventsRequest(logGroupName: java.lang.String, logStreamName: java.lang.String, logEvents: scala.List[org.lyranthe.araethura.logs.models.InputLogEvent], sequenceToken: scala.Option[java.lang.String] = scala.None)
final case class CreateLogStreamRequest(logGroupName: java.lang.String, logStreamName: java.lang.String)
final case class ExportTask(taskName: scala.Option[java.lang.String] = scala.None, status: scala.Option[org.lyranthe.araethura.logs.models.ExportTaskStatus] = scala.None, from: scala.Option[scala.Long] = scala.None, to: scala.Option[scala.Long] = scala.None, executionInfo: scala.Option[org.lyranthe.araethura.logs.models.ExportTaskExecutionInfo] = scala.None, taskId: scala.Option[java.lang.String] = scala.None, destination: scala.Option[java.lang.String] = scala.None, logGroupName: scala.Option[java.lang.String] = scala.None, destinationPrefix: scala.Option[java.lang.String] = scala.None)
