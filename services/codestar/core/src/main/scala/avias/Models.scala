...
final case class ListTeamMembersResult(teamMembers: scala.List[avias.codestar.models.TeamMember], nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListProjectsResult(projects: scala.List[avias.codestar.models.ProjectSummary], nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListResourcesResult(resources: scala.Option[scala.List[avias.codestar.models.Resource]] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListUserProfilesResult(userProfiles: scala.List[avias.codestar.models.UserProfileSummary], nextToken: scala.Option[java.lang.String] = scala.None)
