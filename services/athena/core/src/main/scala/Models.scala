...
final case class BatchGetQueryExecutionOutput(queryExecutions: scala.Option[scala.List[org.lyranthe.araethura.athena.models.QueryExecution]] = scala.None, unprocessedQueryExecutionIds: scala.Option[scala.List[org.lyranthe.araethura.athena.models.UnprocessedQueryExecutionId]] = scala.None)
...
final case class QueryExecution(query: scala.Option[java.lang.String] = scala.None, queryExecutionId: scala.Option[java.lang.String] = scala.None, resultConfiguration: scala.Option[org.lyranthe.araethura.athena.models.ResultConfiguration] = scala.None, status: scala.Option[org.lyranthe.araethura.athena.models.QueryExecutionStatus] = scala.None, queryExecutionContext: scala.Option[org.lyranthe.araethura.athena.models.QueryExecutionContext] = scala.None, statistics: scala.Option[org.lyranthe.araethura.athena.models.QueryExecutionStatistics] = scala.None)
...
final case class ResultConfiguration(outputLocation: java.lang.String, encryptionConfiguration: scala.Option[org.lyranthe.araethura.athena.models.EncryptionConfiguration] = scala.None)
...
final case class ResultSetMetadata(columnInfo: scala.Option[scala.List[org.lyranthe.araethura.athena.models.ColumnInfo]] = scala.None)
...
final case class Row(data: scala.Option[scala.List[org.lyranthe.araethura.athena.models.Datum]] = scala.None)
...
final case class BatchGetNamedQueryOutput(namedQueries: scala.Option[scala.List[org.lyranthe.araethura.athena.models.NamedQuery]] = scala.None, unprocessedNamedQueryIds: scala.Option[scala.List[org.lyranthe.araethura.athena.models.UnprocessedNamedQueryId]] = scala.None)
...
final case class GetQueryExecutionOutput(queryExecution: scala.Option[org.lyranthe.araethura.athena.models.QueryExecution] = scala.None)
final case class GetNamedQueryInput(namedQueryId: java.lang.String)
final case class StartQueryExecutionInput(queryString: java.lang.String, resultConfiguration: org.lyranthe.araethura.athena.models.ResultConfiguration, clientRequestToken: scala.Option[java.lang.String] = scala.None, queryExecutionContext: scala.Option[org.lyranthe.araethura.athena.models.QueryExecutionContext] = scala.None)
final case class GetNamedQueryOutput(namedQuery: scala.Option[org.lyranthe.araethura.athena.models.NamedQuery] = scala.None)
...
final case class ResultSet(rows: scala.Option[scala.List[org.lyranthe.araethura.athena.models.Row]] = scala.None, resultSetMetadata: scala.Option[org.lyranthe.araethura.athena.models.ResultSetMetadata] = scala.None)
...
final case class GetQueryResultsOutput(resultSet: scala.Option[org.lyranthe.araethura.athena.models.ResultSet] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None)