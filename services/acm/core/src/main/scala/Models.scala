package avias.acm.models
final case class DescribeCertificateResponse(certificate: scala.Option[avias.acm.models.CertificateDetail] = scala.None)
final case class RemoveTagsFromCertificateRequest(certificateArn: java.lang.String, tags: scala.List[avias.acm.models.Tag])
final case class ListTagsForCertificateResponse(tags: scala.Option[scala.List[avias.acm.models.Tag]] = scala.None)
...
final case class ListCertificatesResponse(nextToken: scala.Option[java.lang.String] = scala.None, certificateSummaryList: scala.Option[scala.List[avias.acm.models.CertificateSummary]] = scala.None)
final case class RequestCertificateRequest(domainName: java.lang.String, subjectAlternativeNames: scala.Option[scala.List[java.lang.String]] = scala.None, idempotencyToken: scala.Option[java.lang.String] = scala.None, domainValidationOptions: scala.Option[scala.List[avias.acm.models.DomainValidationOption]] = scala.None)
...
final case class AddTagsToCertificateRequest(certificateArn: java.lang.String, tags: scala.List[avias.acm.models.Tag])
...
final case class RenewalSummary(renewalStatus: java.lang.String, domainValidationOptions: scala.List[avias.acm.models.DomainValidation])