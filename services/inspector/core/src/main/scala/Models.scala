...
final case class Subscription(resourceArn: java.lang.String, topicArn: java.lang.String, eventSubscriptions: scala.List[org.lyranthe.araethura.inspector.models.EventSubscription])
...
final case class Finding(createdAt: java.time.Instant, updatedAt: java.time.Instant, arn: java.lang.String, userAttributes: scala.List[org.lyranthe.araethura.inspector.models.Attribute], attributes: scala.List[org.lyranthe.araethura.inspector.models.Attribute], assetAttributes: scala.Option[org.lyranthe.araethura.inspector.models.AssetAttributes] = scala.None, severity: scala.Option[java.lang.String] = scala.None, title: scala.Option[java.lang.String] = scala.None, description: scala.Option[java.lang.String] = scala.None, recommendation: scala.Option[java.lang.String] = scala.None, schemaVersion: scala.Option[scala.Int] = scala.None, confidence: scala.Option[scala.Int] = scala.None, id: scala.Option[java.lang.String] = scala.None, service: scala.Option[java.lang.String] = scala.None, assetType: scala.Option[java.lang.String] = scala.None, numericSeverity: scala.Option[scala.Double] = scala.None, indicatorOfCompromise: scala.Option[scala.Boolean] = scala.None, serviceAttributes: scala.Option[org.lyranthe.araethura.inspector.models.InspectorServiceAttributes] = scala.None)
...
final case class ListTagsForResourceResponse(tags: scala.List[org.lyranthe.araethura.inspector.models.Tag])
final case class PreviewAgentsResponse(agentPreviews: scala.List[org.lyranthe.araethura.inspector.models.AgentPreview], nextToken: scala.Option[java.lang.String] = scala.None)
...
final case class ListEventSubscriptionsResponse(subscriptions: scala.List[org.lyranthe.araethura.inspector.models.Subscription], nextToken: scala.Option[java.lang.String] = scala.None)
final case class ResourceGroup(arn: java.lang.String, tags: scala.List[org.lyranthe.araethura.inspector.models.ResourceGroupTag], createdAt: java.time.Instant)
final case class AddAttributesToFindingsRequest(findingArns: scala.List[java.lang.String], attributes: scala.List[org.lyranthe.araethura.inspector.models.Attribute])
final case class CreateResourceGroupResponse(resourceGroupArn: java.lang.String)
final case class ListFindingsRequest(assessmentRunArns: scala.Option[scala.List[java.lang.String]] = scala.None, filter: scala.Option[org.lyranthe.araethura.inspector.models.FindingFilter] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
final case class AssessmentTemplateFilter(namePattern: scala.Option[java.lang.String] = scala.None, durationRange: scala.Option[org.lyranthe.araethura.inspector.models.DurationRange] = scala.None, rulesPackageArns: scala.Option[scala.List[java.lang.String]] = scala.None)
final case class CreateResourceGroupRequest(resourceGroupTags: scala.List[org.lyranthe.araethura.inspector.models.ResourceGroupTag])
final case class RemoveAttributesFromFindingsResponse(failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
final case class DescribeAssessmentRunsResponse(assessmentRuns: scala.List[org.lyranthe.araethura.inspector.models.AssessmentRun], failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
...
final case class DescribeRulesPackagesResponse(rulesPackages: scala.List[org.lyranthe.araethura.inspector.models.RulesPackage], failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
...
final case class ListAssessmentTemplatesRequest(assessmentTargetArns: scala.Option[scala.List[java.lang.String]] = scala.None, filter: scala.Option[org.lyranthe.araethura.inspector.models.AssessmentTemplateFilter] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
...
final case class DescribeAssessmentTargetsResponse(assessmentTargets: scala.List[org.lyranthe.araethura.inspector.models.AssessmentTarget], failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
...
final case class DescribeAssessmentTemplatesResponse(assessmentTemplates: scala.List[org.lyranthe.araethura.inspector.models.AssessmentTemplate], failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
...
final case class SetTagsForResourceRequest(resourceArn: java.lang.String, tags: scala.Option[scala.List[org.lyranthe.araethura.inspector.models.Tag]] = scala.None)
...
final case class ListAssessmentRunAgentsRequest(assessmentRunArn: java.lang.String, filter: scala.Option[org.lyranthe.araethura.inspector.models.AgentFilter] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
...
final case class DescribeResourceGroupsResponse(resourceGroups: scala.List[org.lyranthe.araethura.inspector.models.ResourceGroup], failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
...
final case class AgentsAlreadyRunningAssessmentException(message: java.lang.String, agents: scala.List[org.lyranthe.araethura.inspector.models.AgentAlreadyRunningAssessment], agentsTruncated: scala.Boolean, canRetry: scala.Boolean)
...
final case class ListAssessmentRunsRequest(assessmentTemplateArns: scala.Option[scala.List[java.lang.String]] = scala.None, filter: scala.Option[org.lyranthe.araethura.inspector.models.AssessmentRunFilter] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
final case class AgentFilter(agentHealths: scala.List[java.lang.String], agentHealthCodes: scala.List[java.lang.String])
final case class CreateAssessmentTemplateRequest(assessmentTargetArn: java.lang.String, assessmentTemplateName: java.lang.String, rulesPackageArns: scala.List[java.lang.String], durationInSeconds: scala.Int, userAttributesForFindings: scala.Option[scala.List[org.lyranthe.araethura.inspector.models.Attribute]] = scala.None)
...
final case class AddAttributesToFindingsResponse(failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
...
final case class DescribeFindingsResponse(findings: scala.List[org.lyranthe.araethura.inspector.models.Finding], failedItems: scala.collection.immutable.Map[java.lang.String, org.lyranthe.araethura.inspector.models.FailedItemDetails])
final case class ListAssessmentTargetsRequest(filter: scala.Option[org.lyranthe.araethura.inspector.models.AssessmentTargetFilter] = scala.None, nextToken: scala.Option[java.lang.String] = scala.None, maxResults: scala.Option[scala.Int] = scala.None)
final case class AssessmentRun(createdAt: java.time.Instant, stateChangedAt: java.time.Instant, arn: java.lang.String, assessmentTemplateArn: java.lang.String, userAttributesForFindings: scala.List[org.lyranthe.araethura.inspector.models.Attribute], name: java.lang.String, rulesPackageArns: scala.List[java.lang.String], stateChanges: scala.List[org.lyranthe.araethura.inspector.models.AssessmentRunStateChange], durationInSeconds: scala.Int, notifications: scala.List[org.lyranthe.araethura.inspector.models.AssessmentRunNotification], findingCounts: scala.collection.immutable.Map[java.lang.String, scala.Int], dataCollected: scala.Boolean, state: java.lang.String, startedAt: scala.Option[java.time.Instant] = scala.None, completedAt: scala.Option[java.time.Instant] = scala.None)
...
final case class AssessmentTemplate(createdAt: java.time.Instant, arn: java.lang.String, assessmentTargetArn: java.lang.String, userAttributesForFindings: scala.List[org.lyranthe.araethura.inspector.models.Attribute], name: java.lang.String, rulesPackageArns: scala.List[java.lang.String], durationInSeconds: scala.Int)
final case class GetTelemetryMetadataResponse(telemetryMetadata: scala.List[org.lyranthe.araethura.inspector.models.TelemetryMetadata])
final case class DescribeAssessmentTemplatesRequest(assessmentTemplateArns: scala.List[java.lang.String])
final case class ListAssessmentRunAgentsResponse(assessmentRunAgents: scala.List[org.lyranthe.araethura.inspector.models.AssessmentRunAgent], nextToken: scala.Option[java.lang.String] = scala.None)
